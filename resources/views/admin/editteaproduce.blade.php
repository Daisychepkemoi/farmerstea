                ...
                <tbody>
                   <tr>
                      <td colspan="" class="" style="">
                         <form class="well form-horizontal" method="POST" action="/editteaproduce/edit/{{$teaproduce->id}}" style=" background-image: url('{{asset('image/desk.jpg')}}'); background-size: cover;opacity: 0.9;color: white; height: 500px;">
                          @csrf
                            <fieldset>
                               <div class="form-group">
                                  ...
                                  <div class="col-md-6 inputGroupContainer">
                                     <div class="input-group"><span class="input-group-addon" style=" height: 50px;"><i class="glyphicon glyphicon-user"></i></span>
                                      <input id="tea_no" name="tea_no" placeholder="Tea Number" class="form-control" required="true" value="{{$teaproduce->tea_no}}" type="number" style=" height: 50px;"></div>
                                  </div>
                               </div>
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-6 inputGroupContainer">
                                     <div class="input-group">
                                        <span class="input-group-addon" style="max-width: 100%; height: 50px;"><i class="glyphicon glyphicon-list"></i></span>
                                      <input id="net_weight" name="net_weight" placeholder="Net Weight" class="form-control" required="true" value="{{$teaproduce->net_weight}}" type="name" style=" height: 50px;" readonly>
