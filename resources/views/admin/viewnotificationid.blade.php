        ...
        <div class="container" id="blog">
            ...
            <div id="products" class="row list-group">
               ...
               @if(auth()->user()->id == $auth->user_id)
                <a href="/vieweventid/edit/{{$notification->id}}" style="float: right; margin-right: 20px; width: 150px;"><button class="btn-danger">Edit</button></a>
                @endif
                @endauth
                    ...
                    <div class="caption">
                        ...
                        <div class="row">
                            {{-- <div class="col-xs-12 col-md-6"> --}}
                                <p class="">Created {{ $notification->created_at->diffForHumans() }}</p>
                            </div>
